"""Package BMT Voice Studio 1.3.0-RC2 into dist/ and release-candidate/. Never touch 1.2.0."""
...
DIST_NAME = "BMTVoiceStudio-1.3.0-RC2"
PORTABLE_NAME = "BMTVoiceStudio-1.3.0-RC2-Windows-x64-Portable"
README = """BMT Voice Studio 1.3.0 RC2
...
def main() -> int:
    ...
    spec = ROOT / "BMTVoiceStudio-1.3.0-RC2.spec"
