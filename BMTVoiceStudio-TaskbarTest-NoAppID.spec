...
"""Diagnostic onedir: NO AppUserModelID. Does not overwrite 1.3.2 FINAL."""
...
a = Analysis(
    ...
    hookspath=[],
    hooksconfig={},
    runtime_hooks=["bmt_voice_studio/runtime_hooks/pyi_rth_taskbar_a.py"],
...
coll = COLLECT(
    ...
    strip=False,
    upx=False,
    name="BMTVoiceStudio-TaskbarTest-NoAppID",
)
